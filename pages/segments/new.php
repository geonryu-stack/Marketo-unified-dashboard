...
<form id="segment-form" class="mt-3">
  ...
  <div class="border rounded p-3 mb-3 bg-light">
    <label class="form-label mb-1">
      ...
      <small class="text-muted fw-normal d-block mt-1">
        Marketo에서 객체(Program/Static List/Email Program 등) 페이지를 열고 주소창의 URL을 그대로 붙여넣으면<br>
  ...
  <div class="row g-3 mb-3">
    ...
    <div class="col-md-4">
      ...
      <select class="form-select" name="marketo_email_program_id" id="m-ep-id" data-current-value="">
  ...
  <div class="alert alert-info small mt-3">
    발송 빈도 cap 및 우선순위 설정은 <a href="<?= APP_URL ?>/rules">발송 Rule</a> 페이지에서 관리합니다.
  </div>
