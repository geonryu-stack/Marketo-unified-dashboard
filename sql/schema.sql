...
CREATE TABLE IF NOT EXISTS `segments` (
  ...
  `cap_per_day` INT NOT NULL DEFAULT 3 COMMENT '동일 수신자에게 같은 날 허용되는 최대 발송 수 (0 = 무제한)',
  `cap_per_week` INT NOT NULL DEFAULT 5 COMMENT '동일 수신자에게 7일 내 허용되는 최대 발송 수 (0 = 무제한)',
  `cap_per_month` INT NOT NULL DEFAULT 15 COMMENT '동일 수신자에게 30일 내 허용되는 최대 발송 수 (0 = 무제한)',
